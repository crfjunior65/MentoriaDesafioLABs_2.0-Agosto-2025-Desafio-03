...
output "bastion_sg_ids" {
  ...
  value       = aws_instance.ec2_bastionhost.vpc_security_group_ids
}

output "bastion_public_ip" {
  description = "The public IP address of the bastion host."
  value       = aws_instance.ec2_bastionhost.public_ip
}

output "bastion_private_ip" {
  description = "The private IP address of the bastion host."
  value       = aws_instance.ec2_bastionhost.private_ip
}

output "bastion_instance_id" {
  description = "The instance ID of the bastion host."
  value       = aws_instance.ec2_bastionhost.id
}
